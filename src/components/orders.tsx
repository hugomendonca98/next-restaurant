 ...
 * @see https://v0.dev/t/6KSWl49Yp1A
 */
    ...
    <div className="grid min-h-screen w-full overflow-hidden lg:grid-cols-[280px_1fr]">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex h-[60px] items-center px-6">
            <Link className="flex items-center gap-2 font-semibold" href="#">
              ...
              <span className="">Next Restaurant</span>
            </Link>
          </div>
      ...
      <div className="flex flex-col">
        <header className="flex h-14 lg:h-[60px] items-center gap-4 border-b bg-gray-100/40 px-6 dark:bg-gray-800/40">
          ...
          <div className="flex-1">
            <h1 className="font-semibold text-lg">Pedidos recentes</h1>
          </div>
              ...
              <DropdownMenuTrigger asChild>
                <Button className="rounded-full" size="icon" variant="ghost">
                  <img
                    ...
                    height="32"
                    src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=128&q=80"
                    style={{
                      aspectRatio: '32/32',
                      objectFit: 'cover',
                    }}
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
          <div className="border shadow-sm rounded-lg p-2">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="w-[100px]">Pedidos</TableHead>
                  <TableHead className="min-w-[150px]">Clientes</TableHead>
